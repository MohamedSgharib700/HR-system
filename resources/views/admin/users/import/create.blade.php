                                        ...
                                        <div class="card">
                                            <form action="{{ route('admin.users.import.store') }}" method="post"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-12">
                                                            <div class="form-group ">
                                                                <label
                                                                    for="select_file">{{ trans('select_file') }}</label>
                                                                <input type="file" class="form-control"
                                                                       name="attendance_file" id="select_file"

                                                                       placeholder="{{ trans('select_file') }} ">
                                                ...
                                                <div class="card-footer">
                                                    <input type="submit" class="btn btn-primary mt-1" value="Import">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
