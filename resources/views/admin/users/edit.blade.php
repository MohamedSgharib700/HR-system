                                            ...
                                            <div class="input-group">
                                                <div class="col-xl-6 col-lg-12 col-md-12 userprofile">
                                                    <div class="userpic mb-2">
                                                        @if($user->image)
                                                            <img src="{{ asset( $user->image) }} " id="upload_img"
                                                                 class="userpicimg"/>
                                                        @else
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="landline_number"
                                                       id="landline_number"  autocomplete="off"
                                    ...
                                    <div class="form-group col-md-12 row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="national_id_number"
                                                   id="national_id_number" autocomplete="off"
                                    ...
                                    <div class="form-group col-md-12 row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="educational_qualification"
                                                   ...
                                                   value="{{ old('educational_qualification', $user->educational_qualification ) }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="special_graduation"
                                                   ...
                                                   value="{{ old('special_graduation', $user->special_graduation ) }}">
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="type" class="form-control select2 w-100" id="types">
                                                    @foreach(UserTypes::getList() as $key => $value)
                                                        <option
                                                            value="{{ $key }}" {{ (old("type") == $key || $user->type == $key)? "selected":null }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="military_status" class="form-control select2 w-100"
                                                    ...
                                                    @foreach(MilitaryStatus::getList() as $key => $value)
                                                        <option
                                                            value="{{ $key }}" {{ (old("military_status") == $key || $user->military_status == $key) ? "selected":null }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="marital_status" class="form-control select2 w-100"
                                                    ...
                                                    @foreach(MaritalStatus::getList() as $key => $value)
                                                        <option
                                                            value="{{ $key }}" {{ (old("marital_status") == $key || $user->marital_status == $key)? "selected":null }}>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="location_id" class="form-control select2 w-100"
                                                    ...
                                                    @foreach($locations as $location)
                                                        <option
                                                            value="{{ $location->id }}" {{ (old("location_id") == $location->id || $user->location_id == $location->id ) ? "selected":null }}>{{ $location->name }}</option>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="department_id" class="form-control select2 w-100"
                                                    ...
                                                    @foreach($departments as $department)
                                                        <option
                                                            value="{{ $department->id }}" {{ (old("department_id") == $department->id  || $user->department_id == $department->id )? "selected":null }}>{{ $department->name }}</option>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="position_id" class="form-control select2 w-100"
                                                    ...
                                                    @foreach($positions as $position)
                                                        <option
                                                            value="{{ $position->id }}" {{ (old("position_id") == $position->id || $user->position_id == $position->id )? "selected":null }}>{{ $position->name }}</option>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="medical_number"
                                                   id="medical_number"
                                                   value="{{ old('medical_number', $user->medical_number ) }}">
                                        </div>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="graduation_grade"
                                                   id="graduation_grade"
                                                   value="{{ old('graduation_grade', $user->graduation_grade ) }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker-deafult"
                                                       ...
                                                       value="{{ old('hiring_date', $user->hiring_date ) }}"
                                                       readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker-deafult"
                                                       ...
                                                       value="{{ old('hiring_date_form_one', $user->hiring_date_form_one ) }}"
                                                       readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker-deafult"
                                                       ...
                                                       value="{{ old('termination_date', $user->termination_date ) }}"
                                                       readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="termination_reason"
                                                   ...
                                                   value="{{ old('termination_reason', $user->termination_reason ) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="annual_vacation_balance"
                                                   ...
                                                   value="{{ old('annual_vacation_balance', $user->annual_vacation_balance ) }}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="net_salary"
                                                   id="net_salary"
                                                   value="{{ old('net_salary', $user->net_salary ) }}">
                                        </div>
                                    </div>
