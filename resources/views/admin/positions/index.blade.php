            ...
            <div class="row">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" type="get" action="{{ route("admin.positions.index") }}">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="table-add float-right">
                                        ...
                                        <a href="{{ route('admin.positions.create') }}" class="btn btn-icon"><i
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon"
                                                               href="{{ route('admin.positions.edit', ['location' => $item]) }}"><i
            ...
            <div class="modal fade" id="delete_model_{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.positions.destroy', ['location' => $item]) }}" method="Post">
                            @method('DELETE')
                            @csrf
