        ...
        <section class="section">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.departments.index') }}" class="text-light-color">Department</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Update Department #{{ $item->id }}</li>
                </ol>
            </div>
            <!--page-header closed-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.departments.update', ['location' => $item]) }}"
                                      method="post">
                                    @method("PUT")
                                    @csrf
